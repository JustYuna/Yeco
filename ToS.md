...
You may not use the Yeco brand, assets, or the official bot instance for commercial exploitation without permission.

- **User Requirements**
Users must be at least 13 years of age (or the minimum age of digital consent in their country) to use Yeco. 
> Users under that age may have their data purged without notice if discovered or reported.

- **Virtual Economy & RMT**
Users are strictly prohibited from trading virtual currency or items for real-world money or services. Any such 'Real Money Trading' (RMT) will result in a permanent ban and data wipe.
...
- **"As-Is" Service:** Yeco is provided "as-is" for Discord communities and users.
- **Uptime:** Yeco does not guarantee any uptime, reliability, or uninterrupted availability.
...
## 3. Privacy
By using Yeco, you acknowledge that user data may be stored and processed as outlined in our [Privacy Policy].
...
## 5. Termination
Access to Yeco may be restricted or revoked at any time for users or servers that violate these terms, abuse bot systems, or interfere with the experience of other users.
